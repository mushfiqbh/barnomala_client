...
<section class="py-16">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap items-end justify-between gap-4">
            <div>
                ...
                <p class="mt-3 max-w-xl text-sm leading-6 text-slate-500">
                    Search your submitted applications by phone number and date of birth to review or edit them.
                </p>
            </div>
        ...
        <div class="mt-8 rounded-4xl bg-white p-6 shadow-sm ring-1 ring-slate-100 sm:p-8">
            ...
            <p class="mt-2 text-sm text-slate-500">Enter the phone number and date of birth you used while applying.</p>
